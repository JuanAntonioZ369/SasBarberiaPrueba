...
Server Components obtienen datos de Supabase → pasan como props `initialXxx` a Client Components. Los Client Components (Managers) manejan estado optimista y llaman directamente a Supabase para mutaciones.
...
- Solo editar archivos dentro de `sasbarberPrueba/`
